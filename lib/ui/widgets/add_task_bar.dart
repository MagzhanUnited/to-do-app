...
class _AddTaskPageState extends State<AddTaskPage> {
  DateTime _sectedDate = DateTime.now();
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              MyInputField(
                title: 'Date',
                hint: DateFormat.yMd().format(_sectedDate),
                widget: IconButton(
                  onPressed: () {
                    _getDateFromUser();
                  },
              ...
              Row(
                ...
                children: [
                  _colorPallete(),
                  MyBatton(label: 'Create Task', onTap: _validateDate)
                ],
              )
            ],
          ),
  ...
  _addTaskToDb() async {
    int value = await _taskController.addTask(
      ...
      date: DateFormat.yMd().format(_sectedDate),
